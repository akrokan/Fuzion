...
<thead>
    <tr class="bg-blue-100 text-left">
        ...
        <th class="w-1/6 px-2 py-2">Created</th>
        <th class="w-1/6 px-2 py-2">Updated</th>
...
<tbody>
    ...
    <tr>
        ...
        <td class="px-2 py-2 flex">
            <a href="{{ url('/dashboard/post/delete/' .$post->id) }}">
        ...
        <td class="px-2 py-2">{{ $post->created_at->format('d/m/Y') }}</td>
        <td class="px-2 py-2">{{ $post->updated_at->format('d/m/Y') }}</td>
        <td class="px-2 py-2">
            @if(!$post->trashed())
                @if($post->state)
